...
const (
	...
	// Editing a host-managed bridge (ifupdown) — DHCP/static addressing.
	ActionHostBridgeEdit = "host_bridge_edit"
	// Renaming the server from Settings → General.
	ActionHostnameChange = "hostname_change"
